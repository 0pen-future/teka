...
import { REPORTS_SEND_KEY, type MemberPermissions } from "../schemas/permission-schemas";
...
export function MemberPermissionsDialog({
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex flex-col divide-y divide-line-200">
