...
var (
	...
	// ErrSelfPacedNoSchedule blocks opening a schedule on a self-paced class;
	// surfaces as 422 SELF_PACED_NO_SCHEDULE.
	ErrSelfPacedNoSchedule = errors.New("self-paced class cannot have schedules")
)
...
// CodeSelfPacedNoSchedule is the wire error code for ErrSelfPacedNoSchedule.
const CodeSelfPacedNoSchedule = "SELF_PACED_NO_SCHEDULE"
