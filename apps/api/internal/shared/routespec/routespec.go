...
var Specs = []Spec{
	...
	perm("GET", "/api/v1/classes/availability", authctx.PermClassesList, none()),
	...
	perm("DELETE", "/api/v1/library/versions/:vid/lessons", authctx.PermLibraryEdit,
		req("template_version.clear_lessons", "template_version", "vid")),
	perm("GET", "/api/v1/library/versions/:vid/exercise-groups", authctx.PermLibraryRead, none()),
	perm("POST", "/api/v1/library/versions/:vid/exercise-groups", authctx.PermLibraryEdit,
		req("template_exercise_group.create", "template_exercise_group", "")),
	perm("DELETE", "/api/v1/library/versions/:vid/exercise-groups/:gid", authctx.PermLibraryEdit,
		req("template_exercise_group.delete", "template_exercise_group", "gid")),
	...
	perm("POST", "/api/v1/library/lessons/:lid/duplicate", authctx.PermLibraryEdit,
		req("template_lesson.duplicate", "template_lesson", "lid")),
	...
	perm("GET", "/api/v1/library/versions/:vid/board", authctx.PermLibraryRead, none()),
	perm("PATCH", "/api/v1/library/lessons/:lid/prep", authctx.PermLibraryEdit,
	...
	perm("PATCH", "/api/v1/library/materials/:id/status", authctx.PermLibraryEdit,
		req("library_material.set_status", "library_material", "id")),
	...
	perm("PATCH", "/api/v1/library/exercises/:id/status", authctx.PermLibraryEdit,
		req("library_exercise.set_status", "library_exercise", "id")),
	...
	perm("GET", "/api/v1/courses/:id/paths", authctx.PermPathsRead, none()),
	perm("GET", "/api/v1/paths", authctx.PermPathsRead, none()),
	perm("POST", "/api/v1/paths", authctx.PermPathsEdit,
		req("learning_path.create", "learning_path", "")),
	perm("GET", "/api/v1/paths/:id", authctx.PermPathsRead, none()),
	perm("PUT", "/api/v1/paths/:id", authctx.PermPathsEdit,
		req("learning_path.update", "learning_path", "id")),
	perm("DELETE", "/api/v1/paths/:id", authctx.PermPathsEdit,
		req("learning_path.delete", "learning_path", "id")),
	perm("POST", "/api/v1/paths/:id/stages", authctx.PermPathsEdit,
		req("path_stage.create", "learning_path", "id")),
	perm("PUT", "/api/v1/paths/:id/stages/order", authctx.PermPathsEdit,
		req("path_stage.reorder", "learning_path", "id")),
	perm("PUT", "/api/v1/paths/:id/stages/:sid", authctx.PermPathsEdit,
		req("path_stage.update", "path_stage", "sid")),
	perm("DELETE", "/api/v1/paths/:id/stages/:sid", authctx.PermPathsEdit,
		req("path_stage.delete", "path_stage", "sid")),
	perm("PUT", "/api/v1/paths/:id/stages/:sid/courses", authctx.PermPathsEdit,
		req("path_stage.set_courses", "path_stage", "sid")),
}
