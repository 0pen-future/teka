...
// the opt-in key that assigns template-lesson preparation; 6 retired
// prep.assign with the lesson preparation feature. Bump on any change that
...
// library write keys carry library.read. An implied key is never a write.
