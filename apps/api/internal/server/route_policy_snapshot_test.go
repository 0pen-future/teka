...
var routePolicySnapshot = []RoutePolicy{
	...
	{Method: "GET", Path: "/api/v1/classes/availability", Kind: PolicyPermission, Key: "classes.list"},
	...
	{Method: "DELETE", Path: "/api/v1/library/versions/:vid/lessons", Kind: PolicyPermission, Key: "library.edit"},
	{Method: "GET", Path: "/api/v1/library/versions/:vid/exercise-groups", Kind: PolicyPermission, Key: "library.read"},
	{Method: "POST", Path: "/api/v1/library/versions/:vid/exercise-groups", Kind: PolicyPermission, Key: "library.edit"},
	{Method: "DELETE", Path: "/api/v1/library/versions/:vid/exercise-groups/:gid", Kind: PolicyPermission, Key: "library.edit"},
	...
	{Method: "POST", Path: "/api/v1/library/lessons/:lid/duplicate", Kind: PolicyPermission, Key: "library.edit"},
	...
	{Method: "PATCH", Path: "/api/v1/library/materials/:id/status", Kind: PolicyPermission, Key: "library.edit"},
	...
	{Method: "PATCH", Path: "/api/v1/library/exercises/:id/status", Kind: PolicyPermission, Key: "library.edit"},
